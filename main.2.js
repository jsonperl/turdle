(this.wordle = this.wordle || {}),
  (this.wordle.bundle = (function (e) {
    ...
    var Za = "IN_PROGRESS",
      es = "WIN",
      as = "FAIL",
      ss = ["Cheater", "Fucking Neat", "Meh", "Amateurish", "Shitty", "Lucky Fuck"],
      ts = (function (e) {
        r(t, e);
        var a = h(t);
        function t() {
                ...
                this.shadowRoot.appendChild(Rs.content.cloneNode(!0)),
                  this.shadowRoot.querySelector(".container").addEventListener("click", function (a) {
                    a.stopPropagation(),
                      ...
                      e.dispatchEvent(new CustomEvent("game-switch-change", { bubbles: !0, composed: !0, detail: { name: e.getAttribute("name"), checked: e.hasAttribute("checked"), disabled: e.hasAttribute("disabled") } }));
                  });
              },
            },
          ],
